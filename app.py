...
def update_data(n, val):  # inpur parameter(s)
    if n == None:
        return "Hey there! Please enter a legitimate stock code to get details.", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQhm6tpIVf45gl8KsQMIBrSCMZJAh8km-Rpg&usqp=CAU","US STOCKS VISUALIZATION ", None, None, None
        # raise PreventUpdate
    else:
        if val == None:
            raise PreventUpdate
